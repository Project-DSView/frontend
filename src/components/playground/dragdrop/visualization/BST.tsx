...
interface NodeComponentProps {
  ...
  onRef: (value: string, el: HTMLDivElement | null) => void;
}
  ...
  (
    ...
    useEffect(() => {
      if (isRunning && !isAnimating) {
        ...
        const targetNode = currentOperationData?.value ?? null;
    ...
    /* ============================================================
        Node Component
    ============================================================ */
    const handleNodeRef = useCallback((value: string, el: HTMLDivElement | null) => {
      nodeRefs.current[value] = el;
    }, []);
    ...
    const renderNode = useCallback(
      (node: PositionedNode) => {
        ...
        const isCurrentlyTraversing = isTraversing && traversalOrder[traverseIndex] === node.value;
