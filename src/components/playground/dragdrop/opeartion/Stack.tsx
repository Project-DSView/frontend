      ...
      <div className="flex flex-wrap gap-2">
        {dragComponents.map((item) => (
          <button
            ...
            className={`cursor-grab rounded-full border px-3 py-1 text-xs font-medium text-gray-800 transition select-none hover:bg-gray-100 active:scale-[0.98] dark:text-gray-100 dark:hover:bg-gray-700 ${item.color}`}
