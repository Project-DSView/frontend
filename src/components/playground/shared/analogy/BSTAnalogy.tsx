...
const TrackPath = ({ from, to, isLeft }: { from: LayoutNode; to: LayoutNode; isLeft: boolean }) => {
  ...
  return (
    <g>
      ...
      <g
        transform={`translate(${(startX + endX) / 2 + (isLeft ? 15 : -15)}, ${(startY + endY) / 2 - 5})`}
      >
  ...
  return (
    <div className="flex w-full flex-col items-center gap-4">
      ...
      <div className="relative mb-2 w-full max-w-xl">
        <div className="flex animate-bounce justify-center opacity-80">
          <svg
            width="30"
            height="30"
            viewBox="0 0 24 24"
      ...
      <div className="relative w-full overflow-hidden rounded-xl bg-gradient-to-b from-blue-50/50 to-indigo-100/50 p-4 shadow-inner dark:from-gray-800/80 dark:to-gray-900/80">
        ...
        <div className="pointer-events-none absolute inset-0 rounded-xl border-4 border-indigo-200 dark:border-indigo-900"></div>
        ...
        <div className="pointer-events-none absolute inset-0">
          <div
            ...
            style={{ maxWidth: vbWidth, aspectRatio: `${vbWidth}/${vbHeight}` }}
          >
      ...
      <div className="mt-4 max-w-lg text-center text-sm text-gray-600 dark:text-gray-400">
        <p>
          ในเกมลูกแก้วตกท่อ: ลูกแก้วใหม่ที่หยอดลงมา จะเจอตะกร้า (Node) รูด้านซ้ายสำหรับ &quot;
          <strong>ค่าน้อยกว่า</strong>&quot; และรูด้านขวาสำหรับ &quot;<strong>ค่ามากกว่า</strong>
          &quot;
          <br />
          ลูกแก้วจะไหลลงไปเรื่อยๆ จนกว่าจะเจอตะกร้าที่ยังว่างอยู่!
        </p>
      </div>
    </div>
  );
