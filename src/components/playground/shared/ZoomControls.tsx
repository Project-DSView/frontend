    ...
    <div className="absolute top-4 right-4 z-10 flex flex-col gap-2 rounded-lg bg-white/90 p-2 shadow-lg backdrop-blur-sm">
      ...
      <div className="flex flex-col gap-1">
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-md bg-blue-500 text-white transition-colors hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed"
          title="Zoom In"
        >
          <ZoomIn size={16} />
        </button>
