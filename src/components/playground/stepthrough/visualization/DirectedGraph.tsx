  ...
  (
    ...
    const renderEdge = useCallback(
      (edge: DirectedGraphEdge): React.ReactNode => {
        ...
        const isHighlighted = highlightedEdges.includes(edge.id) || insertedEdge === edge.id;
      ...
      [data.nodes, data.edges, highlightedEdges, nodePositions, isTransitioning, insertedEdge],
    );
      ...
      >
        ...
        {currentStep && !error && (
          <StepInfoPanel
            ...
            message={currentStep.state.message}
            userCommand={currentStep.state.step_detail?.user_command}
          />
        )}
