...
import { UndirectedGraphVisualizationProps, UndirectedGraphNode, UndirectedGraphEdge } from '@/types';
...
const UndirectedGraphVisualization = forwardRef<HTMLDivElement, UndirectedGraphVisualizationProps>(
  (
    ...
    const renderNode = useCallback((node: UndirectedGraphNode): React.ReactNode => {
    ...
    const renderEdge = useCallback((edge: UndirectedGraphEdge): React.ReactNode => {
