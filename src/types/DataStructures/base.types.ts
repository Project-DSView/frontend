...
interface BaseHookReturn<TData, TStats extends BaseStats, TOperation extends BaseOperation> {
    ...
    clearAll: () => void;
    executeOperation: (operation: TOperation, currentState: BaseState<TData, TStats>) => Promise<BaseState<TData, TStats>>;
  ...
  interface BaseDataStructureService<TData, TStats extends BaseStats, TOperation extends BaseOperation> {
