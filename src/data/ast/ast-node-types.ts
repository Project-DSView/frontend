...
export const AST_NODE_TYPES: Record<string, ASTNodeTypeInfo> = {
  Module: {
    ...
    whyShapedThisWay: 'Python organizes code as modules. The Module node contains all top-level statements.',
  ...
  ClassDef: {
    ...
    whyShapedThisWay: 'Classes are containers for methods and attributes. The AST represents them as nodes with method children.',
  ...
  FunctionDef: {
    ...
    whyShapedThisWay: 'Functions are callable code blocks. The AST shows the function name, parameters, and body as a tree structure.',
  ...
  Call: {
    ...
    whyShapedThisWay: 'Calls have a function (what to call) and arguments (what to pass). The AST shows this as a tree with the function as the root.',
    executionFlow: 'When executed, Python evaluates the function and arguments, then executes the function body.',
  },
  Assign: {
    type: 'Assign',
    ...
    whyShapedThisWay: 'Assignments have targets (where to store) and values (what to store). The AST represents this relationship.',
    executionFlow: 'The right-hand side is evaluated first, then the result is stored in the left-hand side.',
  },
  Attribute: {
    type: 'Attribute',
    ...
    category: 'expression',
    example: 'mylist.head',
    whyShapedThisWay: 'Attributes are accessed through objects. The AST shows the object and attribute name as a parent-child relationship.',
  ...
  If: {
    ...
    whyShapedThisWay: 'If statements have a test condition and body. The AST shows the condition as a child that must be evaluated first.',
    executionFlow: 'The condition is evaluated. If true, the body executes. Otherwise, it\'s skipped.',
  },
  While: {
    type: 'While',
    ...
    whyShapedThisWay: 'While loops have a condition and body. The AST shows this as a tree where the condition is checked repeatedly.',
    executionFlow: 'The condition is evaluated. If true, the body executes and the condition is checked again.',
  },
  For: {
    type: 'For',
    ...
    whyShapedThisWay: 'For loops iterate over sequences. The AST shows the iterator, target variable, and body.',
    executionFlow: 'The sequence is evaluated, then each item is assigned to the target and the body executes.',
  },
  BinOp: {
    type: 'BinOp',
    ...
    category: 'expression',
    example: 'a + b',
    whyShapedThisWay: 'Binary operations have a left operand, operator, and right operand. The AST shows this as a tree.',
    executionFlow: 'Left operand is evaluated, then right operand, then the operation is performed.',
  },
  Compare: {
    type: 'Compare',
    ...
    category: 'expression',
    example: 'start != None',
    whyShapedThisWay: 'Comparisons have a left value, operator, and right value. The AST represents this structure.',
    executionFlow: 'Both sides are evaluated, then the comparison is performed, returning True or False.',
  },
  Constant: {
    type: 'Constant',
    ...
    category: 'expression',
    example: '"Tony" or 42',
    whyShapedThisWay: 'Constants are leaf nodes - they have no children and represent literal values.',
  ...
  Return: {
    ...
    whyShapedThisWay: 'Return statements have an optional value. The AST shows the value as a child node.',
  ...
  Expr: {
    ...
    whyShapedThisWay: 'Expression statements wrap expressions that are executed for their side effects, not their return value.',
