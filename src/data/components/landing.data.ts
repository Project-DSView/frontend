import { Move, StepForward, Zap, MousePointerClick, Footprints, GitBranch, Network, Layers } from 'lucide-react';
...
export { features, visualizationModes, AUTO_SWITCH_INTERVAL, IMAGE_SWITCH_INTERVAL, playgroundIcons, PARTICLE_POSITIONS, structures };
